# Для просмотра решений заданий скачайте документ отчет.docx 
...
*Описание диаграммы вы можете посмотреть в документе отчет.docx*

### <img width="621" alt="4" src="https://github.com/Ma-li-na/Analitica/assets/174958120/6cc5135d-c1d4-4d07-8da7-c8103ed5fc2b">

## Задание 2

*Код и словесное описание вы можете посмотреть в документе отчет.docx*
...
*Словесное описание интерфейса вы можете найти в документе отчет.docx*
...
*Остальные пункты описания функции редактирования можно посмотреть в документе отчет.docx*
